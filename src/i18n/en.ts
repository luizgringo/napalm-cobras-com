/**
 * English (en) translation dictionary for the Napalm Cobras website.
 *
 * @remarks
...
/**
 * English translations, grouped by site area.
 */
export const en: Lang = {
  ...
  meta: {
    ...
    tagline: "Metalpunk from Belo Horizonte, Brazil",
    homeTitle: "Napalm Cobras — Metalpunk from Belo Horizonte",
    homeDesc:
  ...
  band: {
    ...
    timeline: [
      {
        year: "2021",
        text: 'Formed in Belo Horizonte by Uander Trajano, Luiz "Gringo" Bueno and Fred Souza (ex-Fake) — Metalpunk at the intersection of Metal and Punk.',
      },
      {
        year: "2022",
  ...
  music: {
    ...
    discography: [
      { title: "Ao Vivo No Metalpunk Overkill", meta: "Album · 2024" },
  ...
  a11y: {
    images: {
      hero: "Napalm Cobras performing live — metalpunk band from Belo Horizonte, Brazil",
      instagramAvatar: "Instagram profile photo of Napalm Cobras (@{username})",
      instagramPost: "Instagram post by Napalm Cobras (@{username})",
    },
  },
  /** 404 page copy. */
  notFound: {
    ...
    text: "The page you're looking for went on tour, moved, or never existed. Head back home and follow the noise.",
    home: "Back to home",
